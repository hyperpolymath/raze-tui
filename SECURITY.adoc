...
[arabic]
. Navigate to
https://github.com/hyperpolymath/raze-tui/security/advisories/new[Report
a Vulnerability]
...
____
*Note:* PGP encryption for email reports is not yet configured. For
sensitive reports, please use GitHub Security Advisories which provides
...
https://github.com/hyperpolymath/raze-tui/security/advisories[Security
Advisories]
...
|*Security issues*
|https://github.com/hyperpolymath/raze-tui/security/advisories/new[Report
via GitHub] or security@hyperpolymath.org

|*General questions*
|https://github.com/hyperpolymath/raze-tui/discussions[GitHub
Discussions]
...
_Thank you for helping keep raze-tui and its users safe._
