...
// Replace raze-tui, Raze Tui — See README.adoc for details., just run, Raze Tui started successfully. with actuals
= raze-tui — Quick Start for Users
:toc:
:toclevels: 2

== What is raze-tui?

Raze Tui — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./raze-tui-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/raze-tui/wiki
