...
git clone <https://github.com/hyperpolymath/raze-tui.git> cd raze-tui
...
toolbox create raze-tui-dev toolbox enter raze-tui-dev \# Install
...
raze-tui/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/raze-tui/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/raze-tui/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/raze-tui/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/raze-tui/labels/perimeter-3) — Community sandbox scope
