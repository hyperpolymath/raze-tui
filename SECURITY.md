...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/raze-tui/security/advisories/new)
...
- This repository (`hyperpolymath/raze-tui`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/raze-tui/security/advisories)
...
When using raze-tui, we recommend:
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/raze-tui/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/raze-tui/discussions) |
